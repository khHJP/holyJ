...
<main id="chatWrap" class="d-flex flex-nowrap">
  <div id="prof-bar" class="d-flex flex-column flex-shrink-0 bg-light" style="width: 4.5rem;">
    <a href="${pageContext.request.contextPath}/member/myPage.do" class="d-block p-3 link-dark text-decoration-none">
      <img src="${pageContext.request.contextPath}/resources/upload/profile/${member.profileImg}" alt="" style="width: 100%;">
    </a>
    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
      <li class="nav-item">
        <a id="craigBtn" href="#" class="nav-link py-3 border-bottom rounded-0" data-toggle="tooltip" data-placement="right" aria-label="craigChatList" title="중고거래">
      ...
      <li class="nav-item">
        <a id="togetherBtn" href="#" class="nav-link py-3 border-bottom rounded-0" data-toggle="tooltip" data-placement="right" aria-label="togetherChatList" title="같이해요">
