...
$('#craigChat').tooltip({boundart: 'window'})
</script>
...
<jsp:include page="/WEB-INF/views/common/header.jsp">
 ...
 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
  <symbol id="craig" viewBox="0 0 16 16">
...
<main id="chatWrap" class="d-flex flex-nowrap">
  ...
  <div id="prof-bar" class="d-flex flex-column flex-shrink-0 bg-light" style="width: 4.5rem;">
    ...
    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
      <li class="nav-item">
        <a id="craigChat" href="#" class="nav-link active py-3 border-bottom rounded-0" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="craigChatList" data-bs-original-title="craig">
          <svg class="bi pe-none" width="24" height="24" role="img" aria-label="craig"><use xlink:href="#craig"></use></svg>
        </a>
      </li>
      <li class="nav-item">
        <a id="togetherChat" href="#" class="nav-link py-3 border-bottom rounded-0" data-bs-toggle="tooltip" data-bs-placement="right" aria-label="togetherChatList" data-bs-original-title="together">
          <svg class="bi pe-none" width="24" height="24" role="img" aria-label="togetherChatList"><use xlink:href="#speedometer2"></use></svg>
        </a>
      </li>
